...
const Footer = () => {
  return (
    <footer className="bg-surface-container-low w-full py-xl px-4 md:px-gutter max-w-container-max mx-auto border-t border-outline-variant grid grid-cols-2 md:grid-cols-4 gap-lg pb-32 md:pb-xl">
      <div className="col-span-2 md:col-span-1">
        <h3 className="text-headline-md font-headline-md font-bold text-primary mb-4">ĐồCũ</h3>
        <p className="font-body-md text-body-md text-on-surface-variant mb-4">Nền tảng mua bán đồ cũ an toàn, tiện lợi và đáng tin cậy. Renewed Value Community.</p>
        <p className="font-label-sm text-label-sm text-on-surface-variant">© 2024 ĐồCũ. Renewed Value Community.</p>
      </div>
      <div>
